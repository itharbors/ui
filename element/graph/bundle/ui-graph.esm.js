...
var MouseEvent = class extends CustomEvent2 {
  constructor(blocks, lines) {
    super(blocks, lines);
    this.pageX = 0;
    this.pageY = 0;
...
var GraphMouseEvent = class extends MouseEvent {
  constructor(blocks, lines, target) {
    super(blocks, lines);
    this.target = target;
  }
};
var BlockMouseEvent = class extends MouseEvent {
...
var LineMouseEvent = class extends MouseEvent {
...
var BlockEvent = class extends CustomEvent2 {
  constructor(blocks, lines, target, block) {
    super(blocks, lines);
    this.block = block;
    this.target = target;
...
var LineEvent = class extends CustomEvent2 {
  constructor(blocks, lines, target, line) {
    super(blocks, lines);
    this.line = line;
    this.target = target;
